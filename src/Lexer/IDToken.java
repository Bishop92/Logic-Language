...
public class IDToken extends Token {
    ...
    public IDToken(Symbol Symbol_i, int Position_i, int Line_i) {
        this(Symbol_i, Tag.ID, Position_i, Line_i);
    }

    public IDToken(Symbol Symbol_i, Tag Tag_i, int Position_i, int Line_i) {
        super(Tag_i, Position_i, Line_i, Symbol_i.GetName().length());
        Symbol_ = Symbol_i;
    }
